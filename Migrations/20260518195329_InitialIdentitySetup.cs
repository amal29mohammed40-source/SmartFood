        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
          /*  migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    target_calories = table.Column<int>(type: "integer", nullable: false),
                    max_cooking_time = table.Column<int>(type: "integer", nullable: false),
...
*/
          /*  migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_meal_planner", x => x.id);
                    table.ForeignKey(
                        name: "FK_meal_planner_recipes_recipe_id",
                        column: x => x.recipe_id,
                        principalTable: "recipes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
...
*/
            ...
            migrationBuilder.CreateIndex(
                name: "IX_meal_planner_recipe_id",
                table: "meal_planner",
                column: "recipe_id");
        }
